...
dados <- data.frame(
  ...
  Qnt_antendimentos =c(2419318, 2063222, 3289449, 4687771, 6274675, 9292843)
)
...
plot_lin <-ggplot(dados, aes(x = ano, y = Qnt_antendimentos)) +
  ...
  labs(title = "Quantidade de sessões na terapia ocupacional", subtitle = paste("Fonte: Agência Nacional de Saúde Suplementar"))+labs(x = "Ano", y = "Qnt. sessões") +
  theme_minimal() +
